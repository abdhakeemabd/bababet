...
const teamMembers = [
  { id: 1, image: Team1,
     image1: Img1, image2: Img11,
      url: 'https://www.saffronexch.com', username: 'bababetexch', password: 'Bababet1' },
  { id: 2, image: Team3,
     image1: Img2, image2: Img22,
      url: 'https://www.diamondexch99.com', username: 'bababetexch1', password: 'Bababet1' },
  { id: 3, image: Team2,
     image1: Img3, image2: Img33,
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 mb-3" data-aos="fade-down" data-aos-offset="10">
              <h3 className="text-center text-uppercase"></h3>
            </div>
            <Slider {...settings}>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12" data-aos="fade-down" data-aos-offset="10">
              <h3 className="text-center mb-3 text-uppercase font-bold">Our Premium Sites</h3>
            </div>
            {teamMembers.map((member) => (
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 mb-3">
              <h3 className="text-center text-uppercase font-bold mb-3">Our Casino Partners</h3>
            </div>
            <Slider {...casinoSettingLTR}>
              {teamMembers.map((member) => (
                <div className="col-md-4 mb-3" data-aos="fade-up" data-aos-offset="10" key={member.id}>
